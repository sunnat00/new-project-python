...
class Calculator:
    def __init__(self, master):
        ...
        Button(width=17, height=4, text='=', relief='flat', bg='white', command=self.solve).place(x=270 , y=350)
        Button(width=17, height=4, text='C', relief='flat', command=self.clear).place(x=0 , y=350)
